{ myLibs, osConfig, ... }: {
	...
	in {
		homer = {
			...
			volumes = [
				"/assets/config.yml:/${builtins.toJSON homerConfig}"
				"/assets/logo.png:/${builtins.fetchurl {
					url = "https://xenia-images.efi.pages.gay/JF049xenia_happy.png";
					sha256 = "sha256-aS8hrB0iE2fkMjD3CIaPTpqve3bGwRYaOq/0oI2a6yY=";
				}}"
				"/assets/jellyfin.svg:/${builtins.fetchurl {
				...
				"/assets/transmission.png:/${builtins.fetchurl {
				...
				"/assets/radarr.svg:/${builtins.fetchurl {
				...
				"/assets/sonarr.svg:/${builtins.fetchurl {
				...
				"/assets/jacket.png:/${builtins.fetchurl {
				...
				"/assets/bazarr.png:/${builtins.fetchurl {
				...
				"/assets/nginx.png:/${builtins.fetchurl {
				...
				"/assets/proxy.png:/${builtins.fetchurl {
				...
				"/assets/pi.svg:/${builtins.fetchurl {
				...
				"/assets/vaultwarden.svg:/${builtins.fetchurl {
				...
				"/assets/freshrss.svg:/${builtins.fetchurl {
				...
				"/assets/resume.svg:/${builtins.fetchurl {
				...
				"/assets/deemix.svg:/${builtins.fetchurl {
